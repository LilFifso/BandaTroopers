...
/mob/living/carbon/human/proc/play_opening_sequence()
	if(SSticker.intro_sequence)
		sleeping = 11
		addtimer(CALLBACK(src, PROC_REF(play_screen_text), "СОСТОЯНИЕ ГИБЕРНАЦИИ<br><br>СТАТУС СИСТЕМЫ<br>СИСТЕМА ЖИЗНЕОБЕСПЕЧЕНИЯ:ОНЛАЙН<br>СИСТЕМА РАЗМОРОЗКИ:ОНЛАЙН<br>ИММУНИЗАЦИЯ:ВЫПОЛНЕНА<br>СОСТОЯНИЕ ЧЕЛОВЕКА:СТАБИЛЬНО", /atom/movable/screen/text/screen_text/hypersleep_status), 1.25 SECONDS) //SS220
